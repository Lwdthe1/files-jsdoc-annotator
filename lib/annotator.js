...
function genAnnotationsFile({ file, outputDir }) {
  ...
  fs.writeFileSync(
    getFileAnnotationsFilePath(fileRootPath, outputDir),
...
function getFileAnnotationsFilePath(fileRootPath, outputDir) {
  return path.join(__dirname, outputDir, `/gen.annotations.${getFileHash(fileRootPath)}.js`)
}
